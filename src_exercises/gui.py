...
class QuizApp:
    ...
    def show_question(self):
        ...
        tk.Label(
            header_frame,
            text=f"Score: {self.current_quiz.score}",
            bg="#16213e",
            fg="#ffd60a",
            font=("Arial", 12, "bold"),
        ).pack(side="right")
        ...
        tk.Label(
            content_frame, text=progress, bg="#1a1a2e", fg="#a8dadc", font=("Arial", 11)
        ).pack(pady=(20, 5))
    ...
    def answer(self, index):
        ...
        if correct:
            ...
            q = self.current_quiz.get_question(
                self.current_quiz.current_question_index - 1
            )
    ...
    def show_results(self):
        ...
        tk.Label(
            frame, text=msg, font=("Arial", 16, "italic"), bg="#1a1a2e", fg="#a8dadc"
        ).pack(pady=10)
